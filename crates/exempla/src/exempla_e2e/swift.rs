...
// Y: quarantined 2026-08-06 after full Radix e2e measured 93 Swift runnable passes.
// Restore the prior 105 floor when Swift backend execution debt is burned down.
const EXPECTED_SWIFT_PASS_FLOOR: usize = 93;
// Y: quarantined 2026-08-06 after full Radix e2e measured 265 accepted Swift outcomes.
// Restore the prior 300 floor when Swift backend expected-failure metadata is tightened.
const EXPECTED_SWIFT_ACCEPTED_OUTCOME_FLOOR: usize = 265;

...
# formerly: iteraStmt
# [095] itera_stmt
itera_stmt ::= 'itera' ('ex' expression (',' expression)* | 'de' expression | 'ab' expression) apud_clause? ('fixum' | 'varia') itera_binding (block_stmt | ergo_joint statement) cape_clause?
# [096] itera_binding

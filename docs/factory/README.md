...
| Goal | Status | Entry |
| ---- | ------ | ----- |
| Reproducible releases and portable defaults | planning — release provenance, clean-room artifacts, and no-Rust portable workflow delivery split into bounded units | [`release-and-portable-default/delivery.md`](release-and-portable-default/delivery.md) |

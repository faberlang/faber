...
| Goal | Status | Entry |
| ---- | ------ | ----- |
| Inference session boundary | proposed — Faber-owned inference/session boundary and static model artifact oracle check defined; no runtime implementation or capability claim | [`inference-session-boundary/goal.md`](inference-session-boundary/goal.md) |

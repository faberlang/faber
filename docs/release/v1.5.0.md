...
Minor product release spanning **250 commits** since `v1.4.0` (2026-07-31).
...
- Package-crossing nominal types retain canonical identity across analysis
  boundaries, including struct values and enum variants. Missing or conflicting
  identity-bearing variants fail closed (`b1b6ed4`, `5e96ceb`, `2ca42df`).
